...
export default function CreateCity() {
  ...
  const handleSubmit = async (values) => {
    setLoading(true);
    await axiosInstance.post("street-numbers", values);
    setLoading(false);
  ...
  return (
    <>
      ...
      <SweetAlert
        ...
        onConfirm={() => {
          Router.push("/ciphers/street-numbers");
          setNotificationAlertShow(false);
        }}
      >
        Street number is successfully created.
      </SweetAlert>
      ...
      <Formik
        ...
        validationSchema={Yup.object().shape({
          ...
          streetId: Yup.string().required("Field is required."),
        })}
